...
EXCLUDE_REGEX='Tests\.swift$|/Tests/|/Features/|/DesignSystem/|View\.swift$|App\.swift$|WidgetBundle\.swift$|DailyHangulWidget\.swift$|PracticeLiveActivity\.swift$|SpeechService\.swift$|NotificationScheduler\.swift$|BadgeUpdater\.swift$|VocabTimelineProvider\.swift$|StreakTimelineProvider\.swift$'
